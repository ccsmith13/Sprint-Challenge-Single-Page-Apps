...
> Answer: With client-side routing, the page does not have to reload every time it is clicked or updated. With client-side routing the webapp downloads, processes, and displays new data for you.
